...
def test_cited_by_ranks_ukpc_as_near_apex_not_unknown(tmp_path: Path) -> None:
    ...
    (viewer.courts.CANONICAL_COURTS). Pre-1997 UKPC was the ultimate
    appellate court for HK — cited-by rows from a UKPC citer must not
    collapse into the ELSE 99 bucket alongside 'unknown court' anomalies.
